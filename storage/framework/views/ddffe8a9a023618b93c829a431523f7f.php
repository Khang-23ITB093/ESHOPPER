            ...
            <td><span class="text-ellipsis">
              <?php
               if($pro->product_status==0){
                ?>
                <a href="<?php echo e(URL::to('/unactive-product/'.$pro->product_id)); ?>"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                <?php
                 }else{
                ?>  
                 <a href="<?php echo e(URL::to('/active-product/'.$pro->product_id)); ?>"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                <?php
               }
              ?>
            </span></td>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Downloads\Edge\web\eshopper\resources\views/admin/all_product.blade.php ENDPATH**/ ?>